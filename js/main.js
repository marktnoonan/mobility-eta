;(function mobETA() {
	...
	function addLogInScreen() {
		document.querySelector('#mobility-eta').innerHTML =
			...
			etaColors.red +
			'For a demo, enter username <b>test</b> and password <b>test</b>. Contact markthomasnoonan@gmail.com with questions or feedback. </div></div> </div>'
	}
			...
			<div class="progress-wrapper" style="display: inline-block; font-size: 12px;">
				<div class="labels" style="padding-top: 3px; text-align: left; line-height: 1.2; margin-left: -6px;">
					<div class="label left" style="width: auto;text-align: left;display: inline-block;padding: 0;">
						<span class="tool-tip" style="background-color: #fff;color: #000;border-radius: 3px;display: inline-block;padding: 3px;margin-bottom: -2px;">
              <b>Start Window</b>
              <br>${tripDetails.displayReadyTime}</span>
						<div class="down-arrow" style=" position: relative; height: 10px; width: 10px; background-color: #fff; transform: translate(6px, -3px) rotate(45deg); "></div>
					</div>
              ...
              <img src="assets/bus.png" id="martabus" style="height: 26px;padding: 0px 5px 0px 0px; border-left: 108px solid rgba(100, 100, 100, 0.5); border-right: 104px solid rgba(100, 100, 100, 0.5);"
				...
				<div class="eta-tooltip" style="width: auto; text-align: left; position: absolute; margin-top: 4px; margin-left: 100px;">
					<div class="up-arrow" style=" position: relative; height: 10px; width: 10px; background-color: #fff; transform: translate(4px, 0px) rotate(45deg); "></div>
					<span class="tool-tip" style="background-color: #fff;color: #000;border-radius: 3px;display: inline-block;padding: 3px;transform: translateY(-6px); line-height:1.2">
            <b>Your ETA</b>
